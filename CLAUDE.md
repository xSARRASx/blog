...
- **PHASE BROUILLON (en cours)** : toujours `status=draft`, JAMAIS publish. Martin vérifie et clique Publier. Le passage en publication directe se fera uniquement sur instruction explicite de Martin (prévu après 2-3 semaines sans mauvaise surprise sur les images).
